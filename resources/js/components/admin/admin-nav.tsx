    ...
    return (
        <DropdownMenuSub>
            ...
            >
                ...
                {item.badge !== undefined && item.badge > 0 && (
                    <span className={clsx('mr-2', getBadgeStyles(item.badgeType))}>
                        {item.badge}
                    </span>
                )}
            </DropdownMenuSubTrigger>
            <DropdownMenuSubContent
                className="ml-2 min-w-[220px] bg-slate-900 border-slate-800 p-1"
                alignOffset={-5}
            >
                    ...
                    if (hasGrandChildren) {
                        return (
                            <DropdownMenuSub key={child.href} >
                                ...
                                <DropdownMenuSubContent
                                    className="ml-2 min-w-[200px] bg-slate-900 border-slate-800 p-1"
                                >
...
export function AdminNav({ navigation, adminPrefix, currentPath }: AdminNavProps) {
    return (
