...
export const Footer: React.FC<FooterProps> = ({ className }) => {
    return (
        <footer
            className={cn(
                'border-t border-[var(--color-border-light)] bg-[var(--color-background)] py-16',
                className,
            )}
        >
            <Container>
                <div className="grid gap-8 md:grid-cols-4 lg:grid-cols-6">
                    ...
                    <div className="lg:col-span-2">
                        ...
                        <p className="mt-4 max-w-xs text-sm text-[var(--color-text-muted)]">
                            The modern banking solution for businesses and
                            individuals.
                        </p>
                    </div>
                ...
                {/* Bottom */}
                <div className="mt-12 flex flex-col items-center justify-between gap-4 border-t border-[var(--color-border-light)] pt-8 md:flex-row">
