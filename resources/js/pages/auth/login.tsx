...
import { CheckCircle2, Lock, Mail, Shield, TrendingUp, X } from 'lucide-react';
            ...
            >
                <motion.div variants={fadeUp} className="mb-8 text-center">
                    ...
                    <p className="mt-2 text-sm text-zinc-500 dark:text-zinc-400">
                        Sign in to your Neo Bank account
                    </p>
                </motion.div>
                ...
                {status && (
                    <motion.div 
                        variants={fadeUp}
                        className="mt-4 rounded-lg bg-emerald-50 px-4 py-3 text-sm text-emerald-600 dark:bg-emerald-900/20 dark:text-emerald-400"
                    >
                        {status}
                    </motion.div>
                )}
